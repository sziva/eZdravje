...
function dodajMeritveVitalnihZnakov() {
	...
	var KoličinaZaužiteVode = $("#dodajVitalnoKoličinaZaužiteVode").val();
	var ŠteviloZaužitihKalorij = $("#dodajVitalnoŠteviloZaužitihKalorij").val();
	...
	if (!ehrId || ehrId.trim().length == 0) {
      ...
      // https://rest.ehrscape.com/rest/v1/template/Vital%20Signs/example
		    ...
		    "vital_signs/comsumed_water/any_event/comsumed_water": KoličinaZaužiteVode,
		    "vital_signs/comsumed_calories/any_event/comsumed_calories": ŠteviloZaužitihKalorij,
      ...
      "label label-warning fade-in'>Prosim vnesite zahtevan podatek!");
		...
		$.ajax({
          ...
          " " + party.lastNames + "'</b>.</span><br/><br/>");
				...
				if (tip == "Količina zaužite vode") {
					$.ajax({
  					    url: baseUrl + "/view/" + ehrId + "/" + "comsumed_water",
					    type: 'GET',
					    headers: {"Ehr-Session": sessionId},
					    success: function (res) {
					    	if (res.length > 0) {
                    ...
                    "<th class='text-right'>Količina zaužite vode</th></tr>";
						        for (var i in res) {
						            results += "<tr><td>" + res[i].time +
                          "</td><td class='text-right'>" + res[i].comsumed_water +
                          " " + res[i].unit + "</td>";
						        }
						        results += "</table>";
...
$(document).ready(function() {
   ...
   */
	$('#preberiObstojeciVitalniZnak').change(function() {
        ...
        $("#dodajVitalnoKoličinaZaužiteVode").val(podatki[5]);
        $("#dodajVitalnoŠteviloZaužitihKalorij").val(podatki[6]);
	});
